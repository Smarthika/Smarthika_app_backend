    ...
    <View className="flex-1 bg-green-50">
      ...
      <View className="bg-white pt-8 pb-4 px-6 shadow-sm">
        <View className="items-center">
          ...
          <Text className="text-xl font-bold text-green-800">Market</Text>
      ...
      >
        <View className="p-6">
          <View className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 items-center">
            <FontAwesome name="shopping-cart" size={60} color="#10b981" />
            <Text className="text-lg font-bold text-gray-800 mt-4 mb-2">Market Coming Soon</Text>
            <Text className="text-gray-600 text-center text-sm">
              Buy seeds, fertilizers, equipment and sell your produce directly to buyers.
            </Text>
          </View>
        </View>
      </ScrollView>
